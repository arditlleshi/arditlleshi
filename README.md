...
My work focused on frontend implementation and improving user-facing product features using modern frontend technologies.

**Frontend areas I contributed to:**

* Built and improved responsive UI sections for a real production application
* Worked with React, Next.js, TypeScript, Tailwind CSS, GraphQL, and Hasura
* Contributed to reusable components and scalable frontend structure
* Worked on property listing flows, search-related UI, and user-facing pages
* Helped improve responsive layouts for desktop and mobile users
* Contributed to SEO-focused pages and content structure
* Worked with API-connected frontend features and dynamic data
* Collaborated on a private company-owned codebase in a real product environment
...
* Used Angular and TypeScript for the client application
* Used Spring Boot, Java, PostgreSQL, and Docker for the backend setup
